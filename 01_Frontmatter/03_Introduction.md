...
**The adventures** are governed and often created by the orator. Short adventures, referred to as one-shots or side quests, can take anywhere from hours to days to complete, some spanning multiple sessions. Longer adventures can last weeks or months. A traditional adventure is a self-contained quest with a clear goal, though it can also be episodic, with plots unfolding across multiple scenarios. Adventures can span various locations, from cities to dungeons, and even traverse countless worlds, planes, dimensions, and timelines, each offering unique challenges. Beyond being fun to play, adventures drive character development and growth, improving the core features of each character, and much more.
